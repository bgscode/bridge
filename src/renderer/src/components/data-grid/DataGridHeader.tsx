...
export function DataGridHeader<TData>({
...
}: DataGridHeaderProps<TData>): JSX.Element {
  ...
  function setDropHighlight(colId: string | null): void {
  ...
  return (
    <thead className="z-10" style={enableVirtualization ? { display: 'block' } : undefined}>
...
function HeaderCell({
  ...
  function handleDragStart(e: React.DragEvent<HTMLTableCellElement>): void {
    // Block drag if a column resize is in progress
  ...
  function handleDragOver(e: React.DragEvent<HTMLTableCellElement>): void {
  ...
  function handleDragLeave(e: React.DragEvent<HTMLTableCellElement>): void {
  ...
  function handleDrop(e: React.DragEvent<HTMLTableCellElement>): void {
    e.preventDefault()
  ...
  return (
    <th
      ...
      draggable={isDraggable && !column.getIsResizing()}
