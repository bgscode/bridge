...
const DEFAULT_FORM_VALUES: GroupFormValues = { name: '', description: '' }
...
export function GroupForm({
  ...
  const createDraft = usePersistentDraft<GroupFormValues>('groups:create:form:draft:v1')
  ...
  function onValid(values: GroupFormValues): void {
    onSubmit(values)
    if (mode === 'create') {
